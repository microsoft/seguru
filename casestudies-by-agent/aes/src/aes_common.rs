...
pub fn aes128_encrypt_block(plaintext: &[u8; 16], round_keys: &[u32; 44]) -> [u8; 16] {
    ...
    let mut s3 = u32::from_be_bytes([plaintext[12], plaintext[13], plaintext[14], plaintext[15]]);
    ...
    [
        o0[0], o0[1], o0[2], o0[3], o1[0], o1[1], o1[2], o1[3], o2[0], o2[1], o2[2], o2[3], o3[0],
        o3[1], o3[2], o3[3],
    ]
}
