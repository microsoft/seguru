...
use rustc_codegen_ssa_gpu::common::{IntPredicate, RealPredicate, SynchronizationScope, TypeKind};
use rustc_codegen_ssa_gpu::mir::operand::{OperandRef, OperandValue};
use rustc_codegen_ssa_gpu::mir::place::PlaceRef;
...
impl<'a, 'll, 'tcx> BuilderMethods<'a, 'tcx> for Builder<'a, 'll, 'tcx> {
    ...
    fn atomic_rmw(
        ...
        let requires_cast_to_int = self.val_ty(src) == self.type_ptr()
            && op != rustc_codegen_ssa_gpu::common::AtomicRmwBinOp::AtomicXchg;
