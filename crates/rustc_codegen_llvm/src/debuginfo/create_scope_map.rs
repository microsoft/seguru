...
use rustc_codegen_ssa_gpu::mir::debuginfo::{DebugScope, FunctionDebugContext};
...
// FIXME(eddyb) almost all of this should be in `rustc_codegen_ssa_gpu::mir::debuginfo`.
...
fn make_mir_scope<'ll, 'tcx>(
    ...
    let dbg_scope = match scope_data.inlined {
        Some((callee, _)) => {
            ...
            // if this is moved to `rustc_codegen_ssa_gpu::mir::debuginfo`.
