...
use rustc_codegen_ssa_gpu::back::lto::{LtoModuleCodegen, SerializedModule, ThinModule};
use rustc_codegen_ssa_gpu::back::write::{
    CodegenContext, FatLtoInput, ModuleConfig, TargetMachineFactoryConfig, TargetMachineFactoryFn,
};
use rustc_codegen_ssa_gpu::traits::*;
use rustc_codegen_ssa_gpu::{CodegenResults, CompiledModule, ModuleCodegen};
...
"#
    ...
    fn join_codegen(
        ...
        let (codegen_results, work_products) = ongoing_codegen
            .downcast::<rustc_codegen_ssa_gpu::back::write::OngoingCodegen<LlvmCodegenBackend>>()
    ...
    fn link(&self, sess: &Session, codegen_results: CodegenResults, outputs: &OutputFilenames) {
        use rustc_codegen_ssa_gpu::back::link::link_binary;
