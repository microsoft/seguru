...
impl IntPredicate {
    pub(crate) fn from_generic(intpre: rustc_codegen_ssa_gpu::common::IntPredicate) -> Self {
        use rustc_codegen_ssa_gpu::common::IntPredicate as Common;
        match intpre {
...
impl RealPredicate {
    pub(crate) fn from_generic(realp: rustc_codegen_ssa_gpu::common::RealPredicate) -> Self {
        use rustc_codegen_ssa_gpu::common::RealPredicate as Common;
        match realp {
...
impl TypeKind {
    pub(crate) fn to_generic(self) -> rustc_codegen_ssa_gpu::common::TypeKind {
        use rustc_codegen_ssa_gpu::common::TypeKind as Common;
        match self {
...
impl AtomicRmwBinOp {
    pub(crate) fn from_generic(op: rustc_codegen_ssa_gpu::common::AtomicRmwBinOp) -> Self {
        use rustc_codegen_ssa_gpu::common::AtomicRmwBinOp as Common;
        match op {
...
impl AtomicOrdering {
    pub(crate) fn from_generic(ao: rustc_codegen_ssa_gpu::common::AtomicOrdering) -> Self {
        use rustc_codegen_ssa_gpu::common::AtomicOrdering as Common;
        match ao {
