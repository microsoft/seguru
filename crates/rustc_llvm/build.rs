...
fn main() {
    ...
    for lib in output(&mut cmd).split_whitespace() {
        ...
        if (name.starts_with("libz3")) {
            // Not the most elegant way of doing things but libz3.so shows up
            // as /home/linuxbrew/.linuxbrew/lib/libz3.so in
            // llvm-config --link-static --libs --system-libs xxx. If we don't
