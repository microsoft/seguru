...
fn main() {
    ...
    let cu_src = format!("{}/cuda/aes_kernels.cu", cur_dir);
    let obj_path = format!("{}/aes_kernels.o", out_dir);
    let lib_path = format!("{}/libaes_cuda.a", out_dir);
    ...
    println!("cargo:rustc-link-lib=static=aes_cuda");
    println!("cargo:rustc-link-lib=dylib=cudart");
    println!("cargo:rustc-link-lib=dylib=stdc++");
    println!("cargo:rerun-if-changed=cuda/aes_kernels.cu");
    println!("cargo:rerun-if-changed=cuda/aes_kernels.h");
}
